...
// Doubao API key for local dev: read from local.properties (doubao.apiKey, gitignored)
// or the DOUBAO_API_KEY env var. Empty when unset — users enter it via the in-app dialog.
